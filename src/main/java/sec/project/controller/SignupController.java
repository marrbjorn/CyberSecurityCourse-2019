...
public class SignupController {
    ...
    public void init() {
        ...
        signupRepository.save(new Signup("Torvald Algeirsson", "89-559"));
        signupRepository.save(new Signup("Dagbjort og FlokR", "99-111"));
        signupRepository.save(new Signup("Teppa Pekkanen", "29-40-321-5"));
    ...
    public String defaultMapping() {
     ...
     //   Otherwise just will add more protection-layers for the possibility to get page here
   ...
   //     As a result - enough to be logged (but page is 'designed' to be visible not for all logged users);
